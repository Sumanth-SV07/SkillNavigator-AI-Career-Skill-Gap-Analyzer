...
app = Flask(__name__)
app.secret_key = "Skill Navigator"
...
def dashboard():
    ...
    if request.method == 'POST':
        ...
        session['resource_type'] = request.form['resource_type']
...
def result():
    ...
    for skill in missing:
        ...
        if skill_lower in resources:
            selected_resources[skill] = resources[skill_lower][resource_type]
    ...
    return render_template(
        ...
        learning=session.get('resource_type'),
        found=found,
        missing=missing,
        graph=graph_path,
